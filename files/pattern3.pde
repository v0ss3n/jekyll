...
void drawImage(int xC, int yC, float myAngle) {
  pushMatrix();
  translate(img.width/2 + 200*xC - 200, img.height/2 + 200*yC + 100);
...
void drawImageOdd(int xC, int yC, float myAngle) {
  pushMatrix();
  translate(img.width/2 + 200*xC - 300, img.height/2 + 200*yC - 100);
  rotate(PI/2 * -myAngle/90);
  image(img, -img.width/2, -img.height/2 );
  popMatrix();

  pushMatrix();
  translate(img.width/2 + 200*xC - 300, img.height/2 + 200*yC - 300);
  rotate(PI/2 * -myAngle/90);
  image(img, -img.width/2, -img.height/2 );
  popMatrix();
}
